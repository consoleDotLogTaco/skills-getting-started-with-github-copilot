...
activities = {
    ...
    "Drama Club": {
        ...
        "schedule": "Thursdays, 4:00 PM - 6:00 PM; additional rehearsals before shows",
        "max_participants": 30,
    ...
    "Math Club": {
        ...
        "max_participants": 20,
        "participants": ["oliver@mergington.edu", "sophia.j@mergington.edu"]
    },
    "Debate Team": {
        "description": "Develop public speaking, research, and argumentation skills; compete in tournaments",
        "schedule": "Tuesdays, 4:30 PM - 6:00 PM; occasional weekend meets",
        "max_participants": 16,
